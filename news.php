    ...
    <div class="dropdown hidden-md hidden-lg">
      ...
      <ul class="dropdown-menu newsletter" role="menu">
        ...
        foreach($newsletters as $n){
          ...
          if(($current_year=="2016")&&($month=="May"))
            echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . "April/May" . "</a></li>";
          elseif(($current_year=="2016")&&($month=="August"))
            echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . "Summer" . "</a></li>";
          elseif(($current_year=="2016")&&($month=="December"))
            echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . "November/December" . "</a></li>";
          elseif(($current_year=="2015")&&($month=="August"))
            echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . "Summer" . "</a></li>";
		  elseif(($current_year=="2017")&&($month=="October"))
			echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . "Fall" . "</a></li>";
          else
            echo "<li><a target='_blank' href='newsletters/" . $n . "' role='menuitem' tabindex='-16'>" . $month . "</a></li>";
        }
        ?>
    ...
    <div class="newsletters">
      <ul class="list-group col-md-4 hidden-sm hidden-xs">
        ...
        foreach($newsletters as $n){
          ...
          if(($current_year=="2016")&&($month=="May"))
            echo "<li class='list-group-item'><a target = '_blank' href='newsletters/" . $n . "'>" . "April/May" . "</a></li>";
          elseif(($current_year=="2016")&&($month=="August"))
            echo "<li class='list-group-item'><a target = '_blank' href='newsletters/" . $n . "'>" . "Summer" . "</a></li>";
          elseif(($current_year=="2016")&&($month=="December"))
            echo "<li class='list-group-item'><a target = '_blank' href='newsletters/" . $n . "'>" . "November/December" . "</a></li>";
          elseif(($current_year=="2015")&&($month=="August"))
            echo "<li class='list-group-item'><a target = '_blank' href='newsletters/" . $n . "'>" . "Summer" . "</a></li>";
          else
            echo "<li class='list-group-item'><a target = '_blank' href='newsletters/" . $n . "'>" . $month . "</a></li>";
        }
        ?>
      </ul>
    </div>
